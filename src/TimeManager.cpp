...
// Stub for storeDateToFirebase
void storeDateToFirebase()
{
    // Implementation or just a placeholder
}
...
{
    Serial.println("**************(Checking if DST is active...");
    Serial.printf("Current Date and Time: %02d-%02d %02d:%02d\n", day, month, hour, minute());
    int yearNow = year();
    if (month < 3 || month > 10)
        return false;
    if (month > 3 && month < 10)
